    ...
    <Page title="About">
      <Box className="about-content" vfx={{ axis: "y", gap: "m" }}>
        ...
        <ui.p vfx={{ margin: "none" }}>
          ...
          <ui.code>HTTP</ui.code> requests to test your own API endpoints,
          sites, or whatever you find useful. There are a lot of times I want to
          test something without making a complex curl statement, so this will
          help you do the same but much easier!
        </ui.p>
        <ui.h1 vfx={{ margin: "none" }}>How to use</ui.h1>
        <ui.p vfx={{ margin: "none" }}>
          ...
          <ui.code>HTTP</ui.code> method, e.g.{" "}
          <ui.code>GET, POST, PATCH</ui.code> (we'll see which ones I actually
        ...
        <ui.h1 vfx={{ margin: "none" }}>Viewing response</ui.h1>
        <ui.p vfx={{ margin: "none" }}>
